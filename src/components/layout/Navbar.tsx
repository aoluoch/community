...
const navLinks = [
  ...
  { path: '/about', label: 'About Us', icon: <Users className="w-4 h-4 mr-2" /> },
  { path: '/programs', label: 'Programs', icon: <GraduationCap className="w-4 h-4 mr-2" /> },
  { path: '/events', label: 'Events', icon: <Calendar className="w-4 h-4 mr-2" /> },
